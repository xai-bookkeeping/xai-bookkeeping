...
```bash
INIT=$(node "/Users/mali/Development/xai-bookkeeping/.opencode/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/Users/mali/Development/xai-bookkeeping/.opencode/get-shit-done/bin/gsd-tools.cjs" commit \
