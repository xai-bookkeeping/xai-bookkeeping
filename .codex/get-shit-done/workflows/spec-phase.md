...
```bash
INIT=$(node "/Users/mali/Development/xai-bookkeeping/.codex/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/mali/Development/xai-bookkeeping/.codex/get-shit-done/templates/spec.md.
