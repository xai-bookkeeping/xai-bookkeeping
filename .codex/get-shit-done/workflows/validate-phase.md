...
```
Agent(
  prompt="Read /Users/mali/Development/xai-bookkeeping/.codex/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/mali/Development/xai-bookkeeping/.codex/get-shit-done/templates/VALIDATION.md`
