...
```bash
INIT=$(node "/Users/mali/Development/xai-bookkeeping/.codex/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/Users/mali/Development/xai-bookkeeping/.codex/get-shit-done/bin/gsd-tools.cjs" commit \
