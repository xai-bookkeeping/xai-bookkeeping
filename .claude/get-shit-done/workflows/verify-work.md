...
<template>
@/Users/mali/Development/xai-bookkeeping/.claude/get-shit-done/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@/Users/mali/Development/xai-bookkeeping/.claude/get-shit-done/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `/Users/mali/Development/xai-bookkeeping/.claude/get-shit-done/workflows/transition.md`.
...
- Follow @/Users/mali/Development/xai-bookkeeping/.claude/get-shit-done/workflows/diagnose-issues.md
