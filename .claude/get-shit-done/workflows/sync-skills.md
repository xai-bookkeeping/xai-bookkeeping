...
INSTALL_JS_GLOBAL="/Users/mali/Development/xai-bookkeeping/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/mali/Development/xai-bookkeeping/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
