...
export function CustomersClient({ initialData }: { initialData: CustomersResponse }) {
        ...
        <div className="space-y-6">
          <section className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
            ...
            <form onSubmit={submitCreate} className="mt-5 space-y-4">
              <Input label="Customer name" value={createDraft.name} onChange={(e) => setCreateDraft({ ...createDraft, name: e.target.value })} required />
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
            {selected ? (
              <div className="space-y-4">
                ...
                <Input label="Customer name" value={editDraft.name} onChange={(e) => setEditDraft({ ...editDraft, name: e.target.value })} required />
