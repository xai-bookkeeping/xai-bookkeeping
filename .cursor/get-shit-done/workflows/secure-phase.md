...
```
Agent(
  prompt="Read /Users/mali/Development/xai-bookkeeping/.cursor/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/mali/Development/xai-bookkeeping/.cursor/get-shit-done/templates/SECURITY.md`
