 ...
 * Get Auth Bootstrap
 */
export const getAuthBootstrapApiV1AuthBootstrapGet = <ThrowOnError extends boolean = false>(options?: Options<GetAuthBootstrapApiV1AuthBootstrapGetData, ThrowOnError>): RequestResult<GetAuthBootstrapApiV1AuthBootstrapGetResponses, unknown, ThrowOnError> => (options?.client ?? client).get<GetAuthBootstrapApiV1AuthBootstrapGetResponses, unknown, ThrowOnError>({ url: '/api/v1/auth/bootstrap', ...options });
